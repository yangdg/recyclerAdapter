...
import com.yang.recycleradapter.adapter.UserListSingleItemAdapter;
...
public class UserListSingleItemActivity extends BaseRecyclerViewActivity<UserEntity> {
    private static String TAG = "UserListSingleItemActivity";
    private int count=0;
    public static void launch(Context context) {
        Log.d(TAG,"launch");
        Intent intent = new Intent(context, UserListSingleItemActivity.class);
        ...
        return new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                if (chatgroupsEntity != null) {
                    ...
                    Toast.makeText(UserListSingleItemActivity.this,"chatgroupsEntity="+chatgroupsEntity.toString(),Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public MultiItemTypeAdapter<UserEntity> onCreateAdapter(List<UserEntity> data) {
        //返回adapter
        return new UserListSingleItemAdapter(this, data);
    }
    ...
    private void testData(int page) {
        ...
        if(count>=3){
            ...
            entities.add(new UserEntity("1", "老板"));
            entities.add(new UserEntity("1", "经理"));
            entities.add(new UserEntity("1", "赵xx"));
            entities.add(new UserEntity("1", "王xx"));
            entities.add(new UserEntity("1", "员工"));
            ...
            entities.add(new UserEntity("1", "员工6"));
